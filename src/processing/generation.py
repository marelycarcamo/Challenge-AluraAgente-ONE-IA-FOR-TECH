...
Descripción:
Este módulo construye el prompt que será enviado al modelo de
lenguaje y coordina la generación de respuestas basadas únicamente
en información oficial recuperada por el sistema RAG.
